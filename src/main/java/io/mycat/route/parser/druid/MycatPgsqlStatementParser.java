...
/**
 * pg的解析器。和源码中mycat解析器的分离
 * Created by terry.zhang on 2018/10/17.
 */
public class MycatPgsqlStatementParser extends MySqlStatementParser
{
    private static final String LOW_PRIORITY   = "LOW_PRIORITY";
    private static final String LOCAL          = "LOCAL";
    private static final String IGNORE         = "IGNORE";
    private static final String CHARACTER      = "CHARACTER";
    public MycatPgsqlStatementParser(String sql)
    {
        super(sql);
        selectExprParser = new MycatExprParser(sql);
    }

    public MycatPgsqlStatementParser(Lexer lexer)
    {
        super(lexer);
